...
public class JobConstants {
    ...
    public static final int jobOrder = 190;
    ...
    public enum LoginJob {
        ...
        JETT(19, JobFlag.ENABLED, JobEnum.BEGINNER),
        HAYATO(20, JobFlag.ENABLED, JobEnum.HAYATO),
        KANNA(21, JobFlag.ENABLED, JobEnum.KANNA),
        CHASE(22, JobFlag.ENABLED, JobEnum.BEAST_TAMER),
        ;
