...
public class GameConstants {
    public static final int CHANNELS_PER_WORLD = 3/*9*/;
    ...
    public static int getTime() {
        final var time = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime());
        return parseInt(time.substring(0, 4) + time.substring(5, 7) + time.substring(8, 10) + time.substring(11, 13));
    }
}
