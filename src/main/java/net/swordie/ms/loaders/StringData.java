...
public class StringData {
    ...
    public static void loadItemStringsFromWz() {
        ...
        for (String fileDir : files) {
            ...
            nodes.forEach(topNode -> {
                if (!fileDir.equalsIgnoreCase("eqp") &&
                        !fileDir.equalsIgnoreCase("etc")) {
                    XMLApi.getAllChildren(topNode).forEach(mainNode -> {
                    ...
                    XMLApi.getAllChildren(topNode).forEach(category -> XMLApi.getAllChildren(category).forEach(mainNode -> {
                        int id = Integer.parseInt(XMLApi.getNamedAttribute(mainNode, "name"));
                    ...
                    XMLApi.getAllChildren(topNode).forEach(n -> XMLApi.getAllChildren(n).forEach(category -> XMLApi.getAllChildren(category).forEach(mainNode -> {
                        int id = Integer.parseInt(XMLApi.getNamedAttribute(mainNode, "name"));
                        String name = XMLApi.getNamedAttribute(XMLApi.getFirstChildByNameBF(mainNode, "name"), "value");
                        itemStrings.put(id, name);
                    })));
    ...
    public static void loadSkillStringsFromWz() {
        ...
        List<Node> nodes = XMLApi.getAllChildren(XMLApi.getRoot(file));
        nodes.forEach(topNode -> XMLApi.getAllChildren(topNode).forEach(mainNode -> {
    ...
    public static void loadMobStringsFromWz() {
        ...
        nodes.forEach(topNode -> XMLApi.getAllChildren(topNode).forEach(mainNode -> {
            int id = Integer.parseInt(XMLApi.getNamedAttribute(mainNode, "name"));
            XMLApi.getAllChildren(mainNode).forEach(infoNode -> {
