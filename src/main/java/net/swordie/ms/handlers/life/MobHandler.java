...
import static net.swordie.ms.handlers.header.OutHeader.SERVER_ACK_MOB_ZONE_STATE_CHANGE;
...
public class MobHandler {
    ...
    @Handler(op = MOB_SKILL_DELAY_END)
    ...
    @Handler(op = USER_BAN_MAP_BY_MOB)
    ...
    @Handler(op = MOB_EXPLOSION_START)
    ...
    @Handler(op = USER_REQUEST_CHANGE_MOB_ZONE_STATE)
    public static void handleUserRequestChangeMobZoneState(Client c, InPacket inPacket) {
        ...
        var outPacket = new OutPacket(SERVER_ACK_MOB_ZONE_STATE_CHANGE);
        outPacket.encodeByte(true);
        c.write(outPacket);
    }

    @Handler(ops = {MOB_SELF_DESTRUCT, MOB_SELF_DESTRUCT_COLLISION_GROUP})
    ...
    @Handler(op = MOB_AREA_ATTACK_DISEASE)
    ...
    @Handler(op = MOB_REQUEST_ESCORT_INFO)
    ...
    @Handler(op = MOB_ESCORT_COLLISION)
    ...
    @Handler(op = DEMIAN_OBJECT_NODE_END)
    ...
    @Handler(op = DEMIAN_OBJECT_ERR__RECREATE)
    ...
    @Handler(op = STIGMA_DELEVERY_REQUEST)
