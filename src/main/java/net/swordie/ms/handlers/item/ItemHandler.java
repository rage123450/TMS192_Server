...
public class ItemHandler {
    ...
    @Handler(op = USER_PORTAL_SCROLL_USE_REQUEST)
    ...
    @Handler(op = USER_STAT_CHANGE_ITEM_CANCEL_REQUEST)
    ...
    @Handler(op = USER_FREE_MIRACLE_CUBE_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_CONSUME_CASH_ITEM_USE_REQUEST)
    public static void handleUserConsumeCashItemUseRequest(Client c, InPacket inPacket) {
        ...
        if (itemID / 10000 == 553) {
            // Reward items
            Item reward = Objects.requireNonNull(itemInfo).getRandomReward();
    ...
    @Handler(op = USER_STAT_CHANGE_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_SCRIPT_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_EQUIPMENT_ENCHANT_WITH_SINGLE_UI_REQUEST)
    ...
    @Handler(op = USER_SKILL_LEARN_ITEM_USE_REQUEST)
    ...
    @Handler(op = SOCKET_CREATE_REQUEST)
    ...
    @Handler(op = NEBULITE_INSERT_REQUEST)
    ...
    @Handler(op = USER_ITEM_SKILL_SOCKET_UPGRADE_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_ITEM_SKILL_OPTION_UPGRADE_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_WEAPON_TEMP_ITEM_OPTION_REQUEST)
    ...
    @Handler(op = USER_PROTECT_BUFF_DIE_ITEM_REQUEST)
    ...
    @Handler(op = USER_DEFAULT_WING_ITEM)
    ...
    @Handler(op = USER_RECIPE_OPEN_ITEM_USE_REQUEST)
    ...
    @Handler(op = USER_ACTIVATE_NICK_ITEM)
    ...
    @Handler(op = USER_HYPER_SKILL_UP_REQUEST)
    ...
    @Handler(op = USER_HYPER_STAT_SKILL_RESET_REQUEST)
    ...
    @Handler(op = USER_BRIDLE_ITEM_USE_REQUEST)
