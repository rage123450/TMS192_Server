...
public class SkillHandler {
    ...
    @Handler(op = USER_FORCE_ATOM_COLLISION)
...
//            c.write(FieldPacket.damaged(mobID, (long) 133337, mob.getTemplateId(), (byte) 1, (int) mob.getHp(), (int) mob.getMaxHp()));
    ...
    @Handler(op = USER_ACTIVATE_DAMAGE_SKIN)
...
//        c.write(User.setDamageSkin(chr));
    ...
    @Handler(op = USER_ACTIVATE_DAMAGE_SKIN__PREMIUM)
...
//        c.write(User.setPremiumDamageSkin(chr));
    ...
    @Handler(op = USER_DAMAGE_SKIN_SAVE_REQUEST)
    ...
    @Handler(op = USER_CREATE_AURA_BY_GRENADE)
    ...
    @Handler(op = USER_SKILL_USE_REQUEST)
    ...
    @Handler(op = SET_SON_OF_LINKED_SKILL_REQUEST)
    ...
    @Handler(op = USER_DESTROY_GRENADE)
    ...
    @Handler(op = USER_B2_BODY_REQUEST)
    ...
    @Handler(op = MAKING_SKILL_REQUEST)
    ...
    @Handler(op = USER_CREATE_AREA_DOT_REQUEST)
    ...
    @Handler(op = USER_SKILL_PREPARE_REQUEST)
    ...
    @Handler(op = USER_SKILL_CANCEL_REQUEST)
    ...
    @Handler(op = USER_FINAL_ATTACK_REQUEST)
