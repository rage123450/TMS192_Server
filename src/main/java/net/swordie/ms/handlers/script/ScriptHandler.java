...
public class ScriptHandler {
    ...
    @Handler(op = USER_SCRIPT_MESSAGE_ANSWER)
    ...
    @Handler(op = DIRECTION_NODE_COLLISION)
    ...
    @Handler(op = USER_CONTENTS_MAP_REQUEST)
    ...
    @Handler(op = ENTER_RANDOM_PORTAL_REQUEST)
    ...
    @Handler(op = LIBRARY_START_SCRIPT)
    ...
    @Handler(op = CROSS_HUNTER_COMPLETE_REQUEST)
    ...
    @Handler(op = CROSS_HUNTER_SHOP_REQUEST)
