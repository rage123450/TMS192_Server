...
public class MetaProgramming {
    ...
    public static void makeStateless() {
        ...
        Arrays.stream(subDirs).map(subDir -> new File(dir + "/" + subDir)).forEach(exactDir -> {
            Arrays.stream(Objects.requireNonNull(exactDir.listFiles())).forEach(MetaProgramming::makeStateless);
        });
    }
